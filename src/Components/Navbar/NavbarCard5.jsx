          ...
          <Link to="/dogs">
            <Box>
              <Grid gridTemplateColumns="repeat(5, 1fr)" w="100%">
                <Flex direction="column" justifyContent="space-around" mt="20" mr="50px">
                ...
                <Flex direction="column" gap="6">
                  ...
                  <Box fontSize="md" _hover={{ bg: "blackAlpha.200" }} mr="15px"  p="1">
                    DOGS
                    <p>
              ...
              <Grid gridTemplateColumns="repeat(5, 1fr)" w="100%">
                ...
                >
                  <Flex gap="5">
                    <Avatar
                      name="Dan Abrahmov"
                      src="https://thumbs.dreamstime.com/b/dog-food-18690034.jpg"
                      alt="dog food"
                      size="md"
                    />
                    <Box
                  ...
                  <Flex gap="5">
                    <Avatar
                      name="Kola Tioluwani"
                      src="https://thumbs.dreamstime.com/b/dry-cat-food-21132512.jpg"
                      alt="cat food"
                      size="md"
                    />
                    <Box
          ...
          <Link to="/">
            <Box>
              <Grid
                ...
                p="5"
              >
                <Box bg="whiteAlpha.900" h="250px" w="240px" mr="20px">
                  <img
                    className="navImg1"
                    src="https://thumbs.dreamstime.com/b/dog-golden-retriever-683752.jpg"
                    alt="kidsIcon_1"
                  />
                ...
                <Box bg="whiteAlpha.900" h="250px" w="240px">
                  <img
                    className="navImg2"
                    src="https://images.all-free-download.com/images/graphicwebp/cat_cat_face_cats_eyes_240527.webp"
                    alt="kidsIcon_2"
                  />
                  <Box mt="10px" textAlign="center" fontSize="lg">
                    Sell Cats
