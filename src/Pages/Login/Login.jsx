...
const Login = (props) => {
  ...
  const getData = async () => {
    ...
    //   if (loginData.email !== "" && loginData.password !== "") {
    //     const res = await fetch(
    //       "https://33ba-49-204-162-180.ngrok-free.app/app/signin",
    //       {
    //         method: "POST",
    //         body: JSON.stringify(loginData),
    //         headers: {
    ...
    //     if (res) {
    //       const credential = await fetch(
    //         "https://a668-49-204-162-180.ngrok-free.app/app/signin"
    //       );
    //       let cred = await credential.json();
    //       localStorage.setItem("token", data.token);
    //       res1 = cred.filter((el) => el.email === loginData.email);
      ...
      >
        ...
        <ModalContent rounded="3xl">
          ...
          <ModalBody p={"0px 0px "} borderRadius={"15px 15px 15px 15px "}>
            <Image
              src="https://animalso.com/wp-content/uploads/2018/04/Two-German-Shepherds-Weight.jpg"
              alt="pic"
