...
console.log("hshdahs",body)
    ...
    // });
    // ===========================================
// fetch(`https://d834-49-204-162-180.ngrok-free.app/app/signup`)
//       .then((res) => res.json())
//       .then((res) => {
//         res.map((el) => {
//           if (el.email === body.email) {
...
//   url: 'https://d834-49-204-162-180.ngrok-free.app/app/signup',
